<template>
  <div class="footprint-list-page">
    ...
    <div class="page-container">
      ...
      <div class="page-title-section">
        <div class="page-title-wrapper">
          ...
          <div class="title-content">
            <h2 class="page-title">总书记的福建脚步</h2>
      ...
      <!-- 足迹列表 -->
      <div v-if="loading && footprintList.length === 0" class="loading-state">加载中...</div>
      <div v-else-if="footprintList.length === 0" class="empty-state">暂无数据</div>
