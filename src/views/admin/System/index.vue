    ...
    <div class="system-sidebar">
      ...
      >
        ...
        >
          ...
          />
          <path
            d="M12.9 8.7C12.8427 8.90964 12.8427 9.13036 12.9 9.34L13.9 10.34C13.9665 10.4085 14.0129 10.4947 14.0339 10.5886C14.0549 10.6825 14.0497 10.7803 14.019 10.871L13.019 13.371C12.9884 13.4617 12.9332 13.5422 12.8596 13.6032C12.786 13.6641 12.697 13.7029 12.603 13.715L9.9 14.115C9.69036 14.1424 9.49815 14.2424 9.355 14.397L8 15.752"
            stroke="currentColor"
            stroke-width="1.5"
    ...
    <div class="system-content">
        ...
        <div class="form-container">
          <div class="form-row">
            ...
            <div class="form-col">
              <label>系统简称</label>
              <input
                v-model="config.systemShortName"
                type="text"
                class="form-input"
              >
            </div>
            ...
            <div class="logo-upload">
              ...
              <div class="logo-upload-info">
                ...
                >
                  ...
                  >
                    <path
                      d="M7 9.33333V2.33333M4 5.33333L7 2.33333L10 5.33333"
                      stroke="white"
                      stroke-width="1.5"
                      stroke-linecap="round"
                    ...
                    />
                    <path
                      d="M11.6667 9.33333V11.6667C11.6667 11.8435 11.5964 12.013 11.4714 12.1381C11.3464 12.2631 11.1768 12.3333 11 12.3333H3C2.82319 12.3333 2.65362 12.2631 2.5286 12.1381C2.40357 12.013 2.33333 11.8435 2.33333 11.6667V9.33333"
                      stroke="white"
                      stroke-width="1.5"
                      stroke-linecap="round"
                      stroke-linejoin="round"
      ...
      >
        <div class="section-header">
          ...
          <p class="section-desc">
            展示所有一级菜单项，包含：当前名称、显示名称、排序、显示/隐藏
          </p>
        </div>
        ...
        <div class="menu-table">
          <div class="table-header">
            ...
            <div class="th th-display">
              显示名称
            </div>
            <div class="th th-sort">
              排序
            </div>
            <div class="th th-visible">
              显示/隐藏
            </div>
