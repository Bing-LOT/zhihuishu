    ...
    >
      ...
      >
        ...
        <div class="item-thumbnail">
          <img
            :src="item.picUrls?.[0] || '/images/home/video-1.jpg'"
            :alt="item.title"
          >
        </div>
        ...
        <div class="item-content">
          ...
          <div
            ...
            v-html="getPlainText(item.brief)"
          />
        ...
        <div class="dialog__body">
          ...
          <div class="form-group">
            ...
            <div class="image-upload-box multiple">
              ...
              >
              <div
                v-if="formData.picUrls.length > 0"
              ...
              >
                ...
                <div
                  class="image-add-more"
                  @click="triggerPicUrlsUpload"
                >
                  <svg
                    width="40"
                    height="40"
    ...
    >
      <div class="dialog dialog--large">
        ...
        <div class="dialog__body">
          ...
          >
            <div
              v-if="previewData.picUrls && previewData.picUrls.length > 0"
              class="preview-images"
            >
              <img
                v-for="(url, index) in previewData.picUrls"
                :key="index"
                :src="url"
                alt="教师图片"
              >
            ...
            <div class="preview-meta">
              <span>观看链接：<a
                :href="previewData.playUrl"
                target="_blank"
                style="color: #1890ff;"
              >{{ previewData.playUrl }}</a></span>
            </div>
            <div
              class="preview-description"
              v-html="previewData.brief"
            />
            <div class="preview-time">
              创建时间：{{ previewData.createTime }}
            </div>
          </div>
        </div>
      </div>
