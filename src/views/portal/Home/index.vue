<template>
  <div class="home">
    ...
    <section class="home__hero">
      ...
      <!-- 滚动继续提示 -->
      <button
        class="home__scroll-hint"
        @click="scrollToVideo"
      >
        <span>滚动继续</span>
        <div class="home__scroll-icon">
          <img
            src="/images/home__scroll-icon.svg"
            alt="滚动"
          >
        </div>
      </button>
    ...
    >
      ...
      <div class="home__video-background">
        ...
        />
        <div class="home__video-overlay" />
      </div>

      <!-- 视频信息卡片 -->
      <div
        v-if="!videosLoading && videoList.length > 0"
        class="home__video-info"
      >
        <p class="home__video-date">
          {{ videoList[currentVideo]?.createTime || '' }}
        </p>
        <p class="home__video-source">
          {{ videoList[currentVideo]?.college || '' }}
        </p>
        <div class="home__video-title">
          <p>{{ videoList[currentVideo]?.title || '' }}</p>
        </div>
        <div
          v-if="videoList[currentVideo]?.description"
          class="home__video-description"
        >
      ...
      <div
        v-if="!videosLoading && videoList.length > 0"
        class="home__video-carousel"
      >
        <div
          ref="videoListContainer"
          class="home__video-list"
        >
          <VideoCard
        ...
        <div class="home__video-controls">
          ...
          >
            ...
            >
              <path
                d="M36 9C21.0883 9 9 21.0883 9 36C9 50.9117 21.0883 63 36 63C50.9117 63 63 50.9117 63 36C63 21.0883 50.9117 9 36 9Z"
                fill="#BC2220"
              />
              <path
                d="M39 27L30 36L39 45"
                stroke="white"
                stroke-width="2"
                stroke-linecap="round"
                stroke-linejoin="round"
          ...
          >
            ...
            >
              <path
                d="M36 9C50.9117 9 63 21.0883 63 36C63 50.9117 50.9117 63 36 63C21.0883 63 9 50.9117 9 36C9 21.0883 21.0883 9 36 9Z"
                fill="#BC2220"
              />
              <path
                d="M33 27L42 36L33 45"
                stroke="white"
                stroke-width="2"
                stroke-linecap="round"
                stroke-linejoin="round"
